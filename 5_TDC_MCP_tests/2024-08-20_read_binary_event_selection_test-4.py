...
this_histo, edges = np.histogram(vector_ch1, bins=2**16-1, range=(0, 2**16-1))
ax1.step(edges[:-1], this_histo, where='post')

this_histo, edges = np.histogram(vector_ch2, bins=2**16-1, range=(0, 2**16-1))
ax2.step(edges[:-1], this_histo, where='post')

this_histo, edges = np.histogram(vector_ch3, bins=2**16-1, range=(0, 2**16-1))
ax3.step(edges[:-1], this_histo, where='post')

this_histo, edges = np.histogram(vector_ch4, bins=2**16-1, range=(0, 2**16-1))
ax4.step(edges[:-1], this_histo, where='post')

this_histo, edges = np.histogram(vector_ch5, bins=2**16-1, range=(0, 2**16-1))
ax5.step(edges[:-1], this_histo, where='post')
